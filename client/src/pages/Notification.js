    ...
    <Wrapper>
      <div className='notifyArea'>
            <div className='notifications'>
              ...
              {
                dummyy.map((element)=>{
                  return(<div className={"card" + element.type  +( element.read ?  " card " : " card  read" )}   onClick={() => handlePopup(element)}>
              ...
              <Popup clicked = {clicked} type={popUp.type} content = {popUp.content} close = {handlePopupClose}/>
              </div>
            </div>
